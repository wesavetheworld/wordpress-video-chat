...
If you want to use Tinychats original then you'll have to change div ID to client and application ID to tinychat,
also the embed file will need to be changed to <script src="http://tinychat.com/embed/chat.js"></script>
